  ...
  template: `
    <div class="navbar bg-base-100">
      ...
      <div class="navbar-end">
        ...
        <label class="swap swap-rotate ml-4 mr-8">
...
export class HeaderComponent {
  public theme = signal('forest');

  public changeThemeHandler(event: Event): void {
    const changedTheme =
      (event.target as HTMLInputElement).value === 'pastel'
        ? 'forest'
        : 'pastel';

    document.documentElement
      .querySelector('body')
      ?.setAttribute('data-theme', changedTheme);

    this.theme.set(changedTheme);
  }
}
